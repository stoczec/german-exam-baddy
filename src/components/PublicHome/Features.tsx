...
export default function Features() {
  return (
    <section className="flex flex-col items-center justify-center bg-background px-2 py-16 xl:py-28 xl:px-16">
      <h1 className="text-2xl text-left sm:text-center sm:text-3xl md:text-4xl  max-w-3xl font-normal mb-12 lg:mb-20">
